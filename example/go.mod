module github.com/bsv-blockchain/go-p2p-message-bus/example

go 1.24.6

require (
	github.com/bsv-blockchain/go-p2p-message-bus v0.1.0
...
replace github.com/bsv-blockchain/go-p2p-message-bus => ../ //nolint:gomoddirectives // local development
