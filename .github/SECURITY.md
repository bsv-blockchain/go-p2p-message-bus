...
Security is a priority. We maintain a proactive stance to identify and fix vulnerabilities in **go-p2p-message-bus**.

<br/>

## 🛠️ Supported & Maintained Versions
Any released version of **go-p2p-message-bus** that is not marked as deprecated is actively supported and maintained.
